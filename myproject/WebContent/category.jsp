            ...
            <nav class="navbar navbar-default">
                <div class="container">                    
                    <div class="navbar-header navbar-right" style="color:#129bb2">
                     <a href="catadd.jsp" class="btn btn-primary pull-left">AddCategory</a>
                  ...
                  <tbody>
                    <c:forEach var = "row" items = "${result.rows}">
                        <tr>
                        	...
                        	<td><c:out value = "${row.categoryidman}"/></td>
                           <td><c:out value = "${row.categoryName}"/></td>
                           <td><c:out value = "${row.noofproducts}"/></td>
                            <td><a href="editcat.jsp?categoryid=${row.categoryID}" >Edit</a> / <a href="catAddAction.jsp?categoryid=${row.categoryID}&formtype=delete" >Delete</a> </td>
                        </tr>
                     </c:forEach>                    
                  </tbody>
                </table>
